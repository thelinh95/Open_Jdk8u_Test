...
public class NullName {
    ...
    public static void main(String[]args) throws Exception {
        ...
        try {
            ...
            try {
                test.java.io.FilePermission fp =
                    new test.java.io.FilePermission(null, "read");
            } catch (NullPointerException e) {
                count++;
            }

            try {
                test.java.net.SocketPermission sp =
                    new test.java.net.SocketPermission(null, "connect");
            } catch (NullPointerException e) {
                count++;
            }
