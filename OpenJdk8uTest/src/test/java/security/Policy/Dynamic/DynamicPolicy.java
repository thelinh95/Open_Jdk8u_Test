...
public class DynamicPolicy extends Policy{
    ...
    private void initStaticPolicy(PermissionCollection perms) {
        ...
        perms.add(new test.java.security.SecurityPermission("getPolicy"));
        perms.add(new test.java.security.SecurityPermission("setPolicy"));
        perms.add(new test.java.lang.RuntimePermission("stopThread"));
        perms.add(new test.java.net.SocketPermission("localhost:1024-", "listen"));
