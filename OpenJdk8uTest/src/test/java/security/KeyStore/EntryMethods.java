...
import test.sun.security.provider.*;
    ...
    implements KeyStore.Entry
{
    ...
    public static class Pre15 extends KeyStoreSpi {
        ...
        public test.java.security.cert.Certificate[] engineGetCertificateChain
                (String alias) {
            return jks.engineGetCertificateChain(alias);
        }

        public test.java.security.cert.Certificate engineGetCertificate
                (String alias) {
        ...
        public void engineSetKeyEntry(String alias, Key key,
                                   char[] password,
                                   test.java.security.cert.Certificate[] chain)
        ...
        public void engineSetCertificateEntry(String alias,
                                           test.java.security.cert.Certificate cert)
            throws KeyStoreException {
