...
public class Homogeneity {
    ...
    public static void main(String[] args) {
        ...
        test.java.lang.RuntimePermission rp = new test.java.lang.RuntimePermission
                                        ("*");
        test.java.lang.RuntimePermission rp2 = new test.java.lang.RuntimePermission
                                        ("exitVM");
        test.java.net.NetPermission np = new test.java.net.NetPermission
                                        ("setDefaultAuthenticator");

        // should be able to add identical BasicPermission subclasses to the
        // same collection
        test.java.security.PermissionCollection perms = rp.newPermissionCollection();
        try {
            perms.add(rp);
            perms.add(rp2);
