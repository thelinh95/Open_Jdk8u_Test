package test.java.io.Serializable.oldTests;
/*
...
class MissingWriterClass implements test.java.io.Serializable {
    int i = 77;
...
class MissingReaderClass implements test.java.io.Serializable {
    int i = 77;
...
class Validator implements ObjectInputValidation, test.java.io.Serializable  {
