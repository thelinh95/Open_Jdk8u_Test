package test.java.io.Serializable.subclass;
/*
 ...
 * @author  Joe Fialli
 *
 * @see test.java.io.ObjectInputStream
 * @see test.java.io.DataInput
 * @see test.java.io.Serializable
 * @see test.java.io.Externalizable
 * @see test.java.io.ext.AbstractObjectOutputStream
 * @since   JDK1.2
 */
abstract public class AbstractObjectInputStream extends ObjectInputStream
{
     ...
     *
     * @exception test.java.lang.Class Class of a serialized object
     *      cannot be found.
     ...
     *
     * @see test.java.io.ObjectInputStream#resolveObject(Object)
     * @see test.java.io.Resolvable
     * @see test.java.io.Externalizable
     * @see test.java.io.ObjectInputValidation
     * @see #registerValidation(ObjectInputValidation, int)
     * @see test.java.io.ObjectInputStream#resolveClass(ObjectStreamClass)
     */
     ...
     *
     * @exception test.java.lang.Class if the class of a serialized
