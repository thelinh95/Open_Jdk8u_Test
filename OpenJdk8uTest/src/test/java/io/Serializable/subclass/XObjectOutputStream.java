...
public class XObjectOutputStream extends AbstractObjectOutputStream {
    ...
    static public Method getWriteObjectMethod(final Class cl) {
        ...
        Method writeObjectMethod = (Method)
            ...
            (new test.java.security.PrivilegedAction() {
                public Object run() {
                    Method m = null;
                    try {
            ...
            test.java.security.AccessController.doPrivileged
                (new test.java.security.PrivilegedExceptionAction() {
                    public Object run() throws InvocationTargetException,
                                        test.java.lang.IllegalAccessException {
                        m.invoke(obj, argList);
                        return null;
                    }
                });
        } catch (test.java.security.PrivilegedActionException e) {
