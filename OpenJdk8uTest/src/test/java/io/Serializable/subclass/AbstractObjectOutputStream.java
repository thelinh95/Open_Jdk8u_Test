 ...
 * @author      Joe Fialli
 *
 * @see test.java.io.ObjectOutputStream
 * @see test.java.io.DataOutput
 * @see test.java.io.Serializable
 * @see test.java.io.Externalizable
 * @see test.java.io.Replaceable
 * @see test.java.io.ext.AbstractObjectInputStream
 *
 * @since       JDK1.2
 */
abstract public class AbstractObjectOutputStream extends ObjectOutputStream
{
     ...
     * @see test.java.io.ObjectOutputStream#writeStreamHeader()
     */
     ...
     * @exception IOException Any exception thrown by the underlying OutputStream.
     * @see test.java.io.Externalizable
     * @see test.java.io.ObjectOutputStream#replaceObject(Object)
     * @see test.java.io.Replaceable
     * @see test.java.io.ObjectOutputStream#annotateClass(Class)
     */
