package test.java.io.Serializable.serialFilter;
/*
    ...
    static Object[][] objects() {
        ...
        Object[][] objects = {
                ...
                { runnable, 13, 0, 13, 2, 514,
                        Arrays.asList(test.java.lang.invoke.SerializedLambda.class,
                                objArray.getClass(),
                                objArray.getClass(),
                                SerialFilterTest.class,
                                test.java.lang.invoke.SerializedLambda.class)},
                { deepHashSet(10), 48, -1, 50, 11, 619,
                        Arrays.asList(HashSet.class)},
                { proxy.getClass(), 3, -1, 2, 2, 112,
                        Arrays.asList(Runnable.class,
                                test.java.lang.reflect.Proxy.class,
                                test.java.lang.reflect.Proxy.class)},
                { new F(), 6, -1, 6, 6, 202,
