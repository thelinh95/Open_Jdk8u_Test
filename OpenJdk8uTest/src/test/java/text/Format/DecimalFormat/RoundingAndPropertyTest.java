...
public class RoundingAndPropertyTest {
    ...
    private static int testGoldenValues(test.java.text.DecimalFormat df,
                                        test.java.text.DecimalFormat cf) {
    ...
    private static int testSettersAndFastPath(DecimalFormat df,
        ...
        Currency japanCur = test.java.util.Currency.getInstance(Locale.JAPAN);
        firstFormatResult = df.format(d1);
