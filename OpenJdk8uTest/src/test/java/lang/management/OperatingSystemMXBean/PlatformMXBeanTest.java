...
public class PlatformMXBeanTest {
    public static void main(String[] argv) throws Exception {
        ...
        if (osMBean != getOSPlatformMXBean(test.com.sun.management.OperatingSystemMXBean.class)) {
            throw new RuntimeException(
                "Invalid com.sun.management.OperatingSystemMXBean instance");
        }

        if (!System.getProperty("os.name").startsWith("Windows") &&
                osMBean != getOSPlatformMXBean(test.com.sun.management.UnixOperatingSystemMXBean.class)) {
            throw new RuntimeException(
