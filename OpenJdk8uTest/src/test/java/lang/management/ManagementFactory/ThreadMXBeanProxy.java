...
import java.util.concurrent.locks.ConditionObject;
import java.util.concurrent.locks.Lock;
import java.util.concurrent.locks.Sync;
...
import test.java.util.concurrent.locks.*;
...
public class ThreadMXBeanProxy {
    ...
    static class Mutex implements Lock, test.java.io.Serializable {
