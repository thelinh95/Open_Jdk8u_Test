...
import java.lang.management.test;
...
import test.java.lang.management.*;
...
public class ProxyTypeMapping {
    ...
    private static void checkOS() throws Exception {
        test.com.sun.management.OperatingSystemMXBean os =
            newPlatformMXBeanProxy(server,
                                   OPERATING_SYSTEM_MXBEAN_NAME,
                                   test.com.sun.management.OperatingSystemMXBean.class);
    ...
    private static void checkSunGC() throws Exception {
        ...
        for (GarbageCollectorMXBean gc : gcs) {
            test.com.sun.management.GarbageCollectorMXBean sunGc =
               newPlatformMXBeanProxy(server,
                   GARBAGE_COLLECTOR_MXBEAN_DOMAIN_TYPE + ",name=" + gc.getName(),
                   test.com.sun.management.GarbageCollectorMXBean.class);
