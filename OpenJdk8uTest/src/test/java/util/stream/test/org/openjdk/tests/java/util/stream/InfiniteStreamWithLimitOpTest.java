...
import test.java.util.stream.DoubleStreamTestScenario;
import test.java.util.stream.IntStreamTestScenario;
import test.java.util.stream.LambdaTestHelpers;
import test.java.util.stream.LongStreamTestScenario;
import test.java.util.stream.OpTestCase;
import test.java.util.stream.StreamTestScenario;
import test.java.util.stream.TestData;

import static test.java.util.stream.LambdaTestHelpers.assertUnique;
