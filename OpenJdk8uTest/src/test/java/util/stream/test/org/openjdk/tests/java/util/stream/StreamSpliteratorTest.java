...
import static test.java.util.stream.LambdaTestHelpers.irDoubler;
import static test.java.util.stream.LambdaTestHelpers.lpEven;
import static test.java.util.stream.LambdaTestHelpers.mDoubler;
import static test.java.util.stream.LambdaTestHelpers.pEven;
import static test.java.util.stream.LambdaTestHelpers.permuteStreamFunctions;
...
import test.java.util.stream.LambdaTestHelpers;
import test.java.util.stream.LongStreamTestDataProvider;
import test.java.util.stream.OpTestCase;
import test.java.util.stream.SpliteratorTestHelper;
