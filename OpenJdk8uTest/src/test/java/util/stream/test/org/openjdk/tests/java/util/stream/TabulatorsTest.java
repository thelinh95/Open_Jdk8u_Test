...
import test.java.util.stream.StreamOpFlagTestHelper;
...
import static test.java.util.stream.LambdaTestHelpers.assertContents;
import static test.java.util.stream.LambdaTestHelpers.assertContentsUnordered;
