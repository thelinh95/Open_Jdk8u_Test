 ...
 * questions.
 */
package test.java.util.stream.test.org.openjdk.tests.java.util.stream;

import static test.java.util.stream.LambdaTestHelpers.countTo;
import static test.java.util.stream.LambdaTestHelpers.dpEven;
import static test.java.util.stream.LambdaTestHelpers.dpFalse;
import static test.java.util.stream.LambdaTestHelpers.dpOdd;
import static test.java.util.stream.LambdaTestHelpers.dpTrue;
import static test.java.util.stream.LambdaTestHelpers.ipEven;
import static test.java.util.stream.LambdaTestHelpers.ipFalse;
import static test.java.util.stream.LambdaTestHelpers.ipOdd;
import static test.java.util.stream.LambdaTestHelpers.ipTrue;
import static test.java.util.stream.LambdaTestHelpers.lpEven;
import static test.java.util.stream.LambdaTestHelpers.lpFalse;
import static test.java.util.stream.LambdaTestHelpers.lpOdd;
import static test.java.util.stream.LambdaTestHelpers.lpTrue;
import static test.java.util.stream.LambdaTestHelpers.pEven;
import static test.java.util.stream.LambdaTestHelpers.pFalse;
import static test.java.util.stream.LambdaTestHelpers.pOdd;
import static test.java.util.stream.LambdaTestHelpers.pTrue;
...
import test.java.util.stream.DoubleStreamTestDataProvider;
import test.java.util.stream.IntStreamTestDataProvider;
import test.java.util.stream.LongStreamTestDataProvider;
import test.java.util.stream.OpTestCase;
import test.java.util.stream.StreamTestDataProvider;
import test.java.util.stream.TestData;
