...
public class JavatimeTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        int N = 10000;
        long t1970 = new test.java.util.Date(70, 0, 01).getTime();
        Random r = new Random();
        for (int i = 0; i < N; i++) {
            ...
            ///////////// java.util.Date /////////////////////////
            Date jud = new test.java.util.Date(millis);
            ...
            cal.setGregorianChange(new test.java.util.Date(Long.MIN_VALUE));
