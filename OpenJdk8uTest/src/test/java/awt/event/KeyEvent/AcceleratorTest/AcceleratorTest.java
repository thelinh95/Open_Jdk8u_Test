...
public class AcceleratorTest extends JApplet
{
    ...
    public void init()
    {
        ...
        jbu.setMnemonic(test.java.awt.event.KeyEvent.getExtendedKeyCodeForChar('\u042E'));
        ...
        menuItem.setAccelerator(KeyStroke.getKeyStroke(test.java.awt.event.KeyEvent.getExtendedKeyCodeForChar('\u0431'),
        ...
        ks = KeyStroke.getKeyStroke(KeyEvent.getExtendedKeyCodeForChar('\u0436'), test.java.awt.event.InputEvent.ALT_DOWN_MASK);
