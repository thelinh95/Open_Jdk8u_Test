...
public class TestTibetan {
    ...
    private void run()  {
        ...
        try {
            ...
            ourFont = Font.createFont(Font.TRUETYPE_FONT, new test.java.io.File(new test.java.io.File(System.getProperty("user.home"),"fonts"), "Jomolhari-alpha3c-0605331.ttf"));
