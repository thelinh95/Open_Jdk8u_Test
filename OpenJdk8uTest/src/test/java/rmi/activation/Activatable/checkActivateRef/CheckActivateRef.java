        ...
        implements ActivateMe, Runnable
{
    ...
    public static void main(String[] args)  {
        ...
        try {
            ...
            try {
                for (; i < 7; i++) {
                    ...
                    Field f = (Field)
                        test.java.security.AccessController.doPrivileged
                        (new test.java.security.PrivilegedExceptionAction() {
            ...
            } catch (test.java.rmi.UnmarshalException ue) {
                // account for test's activation race condition
                if (ue.detail instanceof test.java.io.IOException) {
                    if ((failures ++) >= 3) {
                        throw ue;
                    }
                } else {
        ...
        } catch (test.java.rmi.activation.ActivationException e) {
            // test only needs to pass 3 times in 7
            if (i < 4) {
                TestLibrary.bomb(e);
            }
        } catch (Exception e) {
            if (e instanceof test.java.security.PrivilegedActionException)
                e = ((test.java.security.PrivilegedActionException)e).getException();
