    ...
    implements ActivateMe
{
    ...
    static {
        try {
            ...
            useNewInvoke = true;
            $method_ping_0 = ActivateMe.class.getMethod("ping", new test.java.lang.Class[] {test.java.lang.String.class});
    ...
    public RestartService_Stub(test.java.rmi.server.RemoteRef ref) {
        super(ref);
    }
        ...
        throws test.java.rmi.RemoteException
    {
        try {
            if (useNewInvoke) {
                ref.invoke(this, $method_ping_0, new test.java.lang.Object[] {$param_String_1}, 8618968970901024056L);
            } else {
