    ...
    implements ActivateMe
{
    ...
    private static test.java.lang.reflect.Method $method_getUnicastVersion_0;
    ...
    static {
        try {
            ...
            useNewInvoke = true;
            $method_getUnicastVersion_0 = ActivateMe.class.getMethod("getUnicastVersion", new test.java.lang.Class[] {});
    ...
    public InactiveGroup_Stub(test.java.rmi.server.RemoteRef ref) {
        super(ref);
    }
