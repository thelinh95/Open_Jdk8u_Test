package test.com.sun.management.ThreadMXBean;
/*
...
public class ThreadCpuTimeArray {
    private static test.com.sun.management.ThreadMXBean mbean =
        (test.com.sun.management.ThreadMXBean)ManagementFactory.getThreadMXBean();
