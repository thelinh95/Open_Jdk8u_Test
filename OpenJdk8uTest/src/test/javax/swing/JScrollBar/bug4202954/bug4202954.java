package test.javax.swing.JScrollBar.bug4202954;
/*
...
public class bug4202954 {
    ...
    public static JButton findJButton(final JScrollBar scrollBar, final int minX, final int minY) throws Exception {
        JButton button = Util.invokeOnEDT(new test.java.util.concurrent.Callable<JButton>() {
            @Override
    ...
    public static boolean doTest(JButton scrollButton, int buttons, boolean expectScroll) throws Exception {
        test.java.util.concurrent.Callable<Integer> horizontalValue = new test.java.util.concurrent.Callable<Integer>() {
            @Override
            public Integer call() throws Exception {
                return buttonScrollPane.getHorizontalScrollBar().getValue();
            }
        };
        test.java.util.concurrent.Callable<Integer> verticalValue = new test.java.util.concurrent.Callable<Integer>() {
            @Override
            public Integer call() throws Exception {
