package test.javax.naming.ldap.LdapName;
/*
...
import test.javax.naming.*;
import test.javax.naming.ldap.*;
...
public class NameTests {
    ...
    public static void main(String args[]) throws Exception {
        ...
        */
        ...
        test.java.util.List prefixList = (dn.getRdns()).subList(0, size /2);
