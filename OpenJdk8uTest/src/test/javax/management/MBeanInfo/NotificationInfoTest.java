package test.javax.management.MBeanInfo;
/*
...
import test.javax.management.relation.*;
import test.javax.management.remote.*;
...
public class NotificationInfoTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CodeSource cs =
            test.java.management.MBeanServer.class.getProtectionDomain()
            .getCodeSource();
        URL codeBase;
        if (cs == null) {
