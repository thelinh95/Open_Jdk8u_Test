package test.javax.security.auth.SubjectDomainCombiner;
/*
...
public class Regression {
    ...
    public static void main(String[] args) {
        ...
        principals.add(new test.com.sun.security.auth.NTUserPrincipal("test1"));
        principals.add(new test.com.sun.security.auth.NTUserPrincipal("test2"));
        ...
        ProtectionDomain d1 = new ProtectionDomain
                                (new CodeSource(url1,
                                    (test.java.security.cert.Certificate[]) null),
                                null,                   // permissions
                                null,                   // class loader
                                null);                  // principals
        ...
        subject.getPrincipals().remove
                (new test.com.sun.security.auth.NTUserPrincipal("test2"));
