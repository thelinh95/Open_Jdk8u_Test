package test.javax.security.auth.x500.X500Principal;
/*
...
public class NameFormat {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            p = new X500Principal(new test.java.io.DataInputStream
                (new test.java.io.ByteArrayInputStream(encoding)));
        } catch (IllegalArgumentException iae) {
        ...
        } catch (test.java.io.IOException ioe) {
            ioe.printStackTrace();
