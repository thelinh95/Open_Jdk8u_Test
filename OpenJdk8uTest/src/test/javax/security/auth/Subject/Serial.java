package test.javax.security.auth.Subject;
/*
...
public class Serial implements test.java.io.Serializable {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            principals.add
                (new test.com.sun.security.auth.NTUserPrincipal("test"));
            principals.add
                (new test.com.sun.security.auth.NTDomainPrincipal("test2"));
