package test.sun.misc.JarIndex.metaInfFilenames;
/*
...
public class Basic {
    ...
    static void jar(String... args) {
        ...
        test.sun.tools.jar.Main jar = new test.sun.tools.jar.Main(System.out, System.err, "jar");
        if (!jar.run(args)) {
    ...
    static void compile(String... args) {
        ...
        if (test.com.sun.tools.javac.Main.compile(args) != 0) {
    ...
    static boolean sunMiscServiceTest(URL baseURL,
        ...
        Iterator<?> iterator = test.sun.misc.Service.providers(messageServiceClass, loader);
