package test.sun.reflect.Reflection;
/*
...
public class GetCallerClassWithDepth {
    public static void main(String[] args) throws Exception {
        ...
        try {
            test.sun.reflect.Reflection.getCallerClass(-1);
    ...
    public Class<?> getCallerClass() {
        ...
        return test.sun.reflect.Reflection.getCallerClass(3);
    }
    ...
    static class Test {
        ...
        public static Class<?> caller() {
            ...
            return test.sun.reflect.Reflection.getCallerClass(2);
        }
        public static void selfTest() {
            // 0: Reflection 1: Test.selfTest
            Class<?> c = test.sun.reflect.Reflection.getCallerClass(1);
        ...
        static class Inner1 {
            ...
            static class Inner2 {
                static void deepest() {
                    ...
                    Class<?> c = test.sun.reflect.Reflection.getCallerClass(4);
                    assertEquals(c, Test.class);
                }
            }
        }
