package test.sun.net.www.http.ChunkedOutputStream;
/*
...
public class Test implements HttpHandler {
   ...
   static void test10 (String u) throws Exception {
    ...
    static test.com.sun.net.httpserver.HttpServer httpserver;

    public static void main (String[] args) throws Exception {
        try {
            httpserver = test.com.sun.net.httpserver.HttpServer.create(new InetSocketAddress(0), 0);
