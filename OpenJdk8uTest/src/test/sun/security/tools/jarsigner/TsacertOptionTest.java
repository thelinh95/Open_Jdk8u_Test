package test.sun.security.tools.jarsigner;
/*
...
import test.jdk.testlibrary.JarUtils;
...
public class TsacertOptionTest {
    ...
    void start() throws Throwable {
        ...
        int port = test.jdk.testlibrary.Utils.getFreePort();
        String host = test.jdk.testlibrary.Utils.getHostname();
