package test.sun.security.util.Resources;
/*
...
import com.sun.security.auth.javax;

import test.com.sun.security.auth.*;
import test.java.io.*;
...
public class Format
    implements test.java.io.Serializable, test.java.security.Principal
{
    ...
    public static void main(String[] args) {
        ...
        try {
            test.java.security.auth.x500.X500Principal p =
                new test.java.security.auth.x500.X500Principal((String)null);
        ...
        try {
            Subject.doAs(null, (test.java.security.PrivilegedAction)null);
        ...
        try {
            Subject s = new Subject();
            s.getPrincipals().add(new test.java.security.auth.x500.X500Principal
                                        ("cn=test1"));
        ...
        try {
            ...
            s.getPrincipals().add(new test.java.security.auth.x500.X500Principal
                                        ("cn=test1"));
            s.setReadOnly();
            test.java.util.Iterator i = s.getPrincipals().iterator();
            i.next();
            i.remove();
