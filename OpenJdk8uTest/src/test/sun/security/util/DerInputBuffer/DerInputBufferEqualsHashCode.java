package test.sun.security.util.DerInputBuffer;
/*
...
import test.sun.security.util.*;
import test.sun.security.x509.*;
...
public class DerInputBufferEqualsHashCode {
    ...
    public static void main(String[] args) throws Exception {
        ...
        test.java.security.AccessController.doPrivileged(a);
...
class GetDIBConstructor implements test.java.security.PrivilegedExceptionAction {
