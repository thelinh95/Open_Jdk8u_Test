package test.sun.security.provider.PolicyParser;
/*
...
public class PrincipalExpansionError {
    ...
    public static void main(String[] args) {
        ...
        } catch (test.java.security.PrivilegedActionException pae) {
            Exception e = pae.getException();

            if (e instanceof test.java.io.FileNotFoundException) {
                System.out.println
                    ("PrincipalExpansionError test failed (file not found)");
                test.java.io.FileNotFoundException fnfe =
                        (test.java.io.FileNotFoundException)e;
