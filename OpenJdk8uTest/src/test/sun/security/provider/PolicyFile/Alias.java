...
public class Alias {
    ...
    public static void main(String[] args) {
        ...
        principals[0] = new test.com.sun.security.auth.UnixPrincipal("unix");
        principals[1] = new test.java.security.auth.x500.X500Principal("cn=x509");
        principals[2] = new test.java.security.auth.x500.X500Principal
                                        ("emailaddress=duke@sun");

        test.java.net.URL url = null;
        try {
            url = new test.java.net.URL("http://alias");
        } catch (test.java.net.MalformedURLException mue) {
            System.out.println("test 1 failed");
            throw new SecurityException(mue.getMessage());
        }
        CodeSource cs =
            new CodeSource(url, (test.java.security.cert.Certificate[]) null);
